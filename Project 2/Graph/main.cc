...
int main(int argc, char** argv){
    ...
    do {
        ...
        double max_epsilon = *std::max_element(epsilon.begin(), epsilon.end());
        ...
        // Print metrics
        output << "MAF: " << max_epsilon << std::endl;
        ...
        if (m == 1) {
            std::cout << "| " << k << " | " << R << " | " << E << " | " << max_epsilon << " | " << mean_epsilon << " | " << mean_approx_time << " | " << mean_true_time << " |" << std::endl;
        } else {
            std::cout << "| " << l << " | " << max_epsilon << " | " << mean_epsilon << " | " << mean_approx_time << " | " << mean_true_time << " |" << std::endl;
        }
